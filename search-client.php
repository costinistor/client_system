...
if(isset($_POST['sub_search'])){
	...
	$query_s = "SELECT * FROM clienti WHERE CONCAT(nume,tel,plecare,ora,dest) LIKE '%".$search."%'";
...
<div class="container">
     ...
     <!-- <div class="jumbotron">
	  ...
	  <div class="row search-section">
	  		<div class="col-md-4">
				<a href="search-client.php" class="btn btn-warning btn-sm show-btn">Show All</a>
			</div>
			<!-- search -->
			<div class="search-box col-md-8">		
				<form class="search pull-right" method="post" action="search-client.php">
